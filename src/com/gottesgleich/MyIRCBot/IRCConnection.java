...
public class IRCConnection {
	...
	public IRCConnection(String host, String user) throws UnknownHostException,
			IOException {
		this(host, user, 6667);
	}

	public IRCConnection(String host, String user, int port)
	...
	private void register() throws IOException {
		...
		this.out.addMessage(new IrcProtocol(Action.RAW, "NICK " + this.username
				+ "\n\r", ""), true);
		this.out.addMessage(
				new IrcProtocol(Action.RAW, "USER " + this.username
						+ " localhost " + this.host + ": " + this.username
						+ "\n\r", ""), true);
	}
